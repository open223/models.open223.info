...
This example Building 1-1 model is provided by current and former NIST staff and Pacific Northwest National Laboratory. See also [bdg1-2](../bdg1-2.md) for an different modeling approach for the same building.
